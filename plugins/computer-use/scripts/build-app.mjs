...
//
// Zero dependencies; runs on any OS and builds every layout (icons are
// pre-generated by scripts/build-icons.mjs and committed).
//
...
import { ICON_NAME } from "./build-icons.mjs";
