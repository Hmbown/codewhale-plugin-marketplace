 ...
 * which is also exactly as long as Codewhale for Chrome should be able to touch a page.
 */

chrome.sidePanel
  .setPanelBehavior({ openPanelOnActionClick: true })
  .catch((error) => console.error("Codewhale for Chrome: could not bind the toolbar button", error));
